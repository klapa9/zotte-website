...
export const ideas: Idea[] = [
  ...
  },
  {
    ...
    longText: [
        "Onze gedachten en intenties vormen de basis van hoe onze werkelijkheid zich ontvouwt. Alles waar je focus en energie aan geeft, krijgt kracht en vorm.",
        "Jij kan beïnvloeden wat gebeurt in de wereld door te ‘kiezen’ waar energie en aandacht naartoe gaat.",
