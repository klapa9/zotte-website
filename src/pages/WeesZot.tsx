      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 px-4 pb-16">
          <div className="max-w-6xl mx-auto space-y-16">
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-white border-opacity-20 transform hover:scale-105 transition-all duration-500">
            ...
            {/* Intuïtie Section */}
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-8 md:p-12 transform hover:rotate-2 transition-all duration-500">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
            ...
            {/* Dieper Gaan Section */}
            <div className="bg-black bg-opacity-30 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-white border-opacity-20 transform hover:-rotate-1 transition-all duration-500">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-6">
