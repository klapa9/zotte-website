      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 px-4 pb-16">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-purple-400 to-yellow-600 rounded-3xl p-8 md:p-12 mb-12 transform hover:scale-105 hover:rotate-2 transition-all duration-500 cursor-pointer active:scale-95">
